...
import com.bagaspardanailham.mylocationtracker.databinding.ActivityMapsBinding
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                for (location in locationResult.locations) {
                    ...
                    val lastLtLng = LatLng(location.latitude, location.longitude)

                    // draw polyline
                    allLatLng.add(lastLtLng)
                    mMap.addPolyline(
                        PolylineOptions()
                            .color(Color.CYAN)
                            .width(10f)
                    ...
                    // set boundaries
                    boundsBuilder.include(lastLtLng)
